...
function App() {
  ...
  <div className='bg-black w-full h-screen flex justify-center py-11 text-orange-400'>
     <div className='bg-gray-800 h-[15%] w-[90%] sm:w-[35%] rounded-lg flex flex-col py-4 px-5 gap-8 min-w-[550px] '>

                        {/* upper scetion */}
            <div className='flex gap-3'>
              <input className='w-[87%] h-11 rounded-lg ' value={password} type="text" readOnly ref={passRef} />
